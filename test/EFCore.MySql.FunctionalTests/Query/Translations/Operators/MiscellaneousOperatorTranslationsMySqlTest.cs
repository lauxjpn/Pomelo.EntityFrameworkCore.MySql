...
public class MiscellaneousOperatorTranslationsMySqlTest : MiscellaneousOperatorTranslationsTestBase<BasicTypesQueryMySqlFixture>
{
    public MiscellaneousOperatorTranslationsMySqlTest(BasicTypesQueryMySqlFixture fixture, ITestOutputHelper testOutputHelper)
        : base(fixture)
    {
