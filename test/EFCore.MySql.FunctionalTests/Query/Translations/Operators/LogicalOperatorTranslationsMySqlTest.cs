...
public class LogicalOperatorTranslationsMySqlTest : LogicalOperatorTranslationsTestBase<BasicTypesQueryMySqlFixture>
{
    public LogicalOperatorTranslationsMySqlTest(BasicTypesQueryMySqlFixture fixture, ITestOutputHelper testOutputHelper)
        : base(fixture)
    {
