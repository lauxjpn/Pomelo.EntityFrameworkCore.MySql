...
public class ComplexTypeQueryMySqlTest : ComplexTypeQueryRelationalTestBase<
    ComplexTypeQueryMySqlTest.ComplexTypeQueryMySqlFixture>
{
    public ComplexTypeQueryMySqlTest(ComplexTypeQueryMySqlFixture fixture, ITestOutputHelper testOutputHelper)
        : base(fixture)
    {
...
""");
    ...
    public class ComplexTypeQueryMySqlFixture : ComplexTypeQueryRelationalFixtureBase
    {
